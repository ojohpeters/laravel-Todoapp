<x-base title="Register">
    <form action="{{route('makeuser')}}" method="POST" class="max-w-sm mx-auto">
        @csrf
        <div class="mb-5">
        ...
        <div class="mb-5">
            ...
            <input type="email" id="email"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                placeholder="name@sacs.com" name="email" />
                @error('email')
                <div class="text-red-500">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="flex items-start mb-5">
            ...
            <label for="remember" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300" name="Remeber" value="1">Remember me</label>
        </div>
        <button type="submit"
